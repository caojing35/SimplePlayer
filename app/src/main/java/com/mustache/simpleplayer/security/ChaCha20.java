package com.mustache.simpleplayer.security;
...
public class ChaCha20 {
    ...
    static byte[] DEFAULT_KEY = new byte[]{-109, -59, -34, -48, 95, 44, 59, 72, 42, 22, -15, -66, 80, -80, -46, 51, -122, 115, 71, -91, 96, 55, 88, -42, 43, -3, -43, 50, -87, 1, -51, -36};

    static byte[] DEFAULT_NONCE = new byte[]{100, -84, 102, 123, -17, -21, -9, -31};

    static int DEFAULT_COUNTER = 1;
    ...
    public ChaCha20() throws WrongKeySizeException, WrongNonceSizeException {
        this(DEFAULT_KEY, DEFAULT_NONCE, DEFAULT_COUNTER);
    }
    ...
    public static class Encryptor{
        ...
        public byte[] encrypt(byte[] text, int len){
            byte[] result = new byte[len];
            chaCha20.encrypt(result, text, len);
            return result;
        }

        public byte[] decrypt(byte[] text, int len){
            byte[] result = new byte[len];
            chaCha20.decrypt(result, text, len);
            return result;
